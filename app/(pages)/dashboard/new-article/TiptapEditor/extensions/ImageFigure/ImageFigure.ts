...
// @ts-ignore : This import is no longer needed and caused the error.
				...
				props: {
					handleDOMEvents: {
						dragstart: (view, event) => {
							...
							// 🔑 FIX: Access serializeForClipboard directly on the 'view' object.
							// biome-ignore lint/suspicious/noExplicitAny: error
							const { dom, text, slice } = (view as any).serializeForClipboard(
								draggedSlice,
							);
