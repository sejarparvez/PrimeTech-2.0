/** biome-ignore-all lint/a11y/noSvgWithoutTitle: this is fine */
'use client';
      ...
      <div className='container mx-auto'>
        <div className='grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5 lg:gap-12'>
          <div className='flex flex-col items-center text-center lg:col-span-2 lg:items-start lg:text-left'>
            <h2 className='mb-4 text-3xl font-bold text-primary'>PrimeTech</h2>
            <p className='mb-6 max-w-xs text-muted-foreground'>
              Insights on technology, development, and design. Stay ahead with
              the latest in tech.
            </p>
            <div className='mb-6 flex space-x-4'>
              {[
                {
                  label: 'Facebook',
                  href: 'https://www.facebook.com/primetechblog',
                  svg: (
                    <svg
                ...
                {
                  label: 'Twitter',
                  href: 'https://www.twitter.com/primetechblog',
                  svg: (
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      viewBox='0 0 24 24'
                ...
                {
                  label: 'Instagram',
                  href: 'https://www.instagram.com/primetechblog',
                  svg: (
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      viewBox='0 0 24 24'
                ...
                {
                  label: 'LinkedIn',
                  href: 'https://www.linkedin.com/company/primetechblog',
                  svg: (
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      viewBox='0 0 24 24'
                ...
                {
                  label: 'GitHub',
                  href: 'https://www.github.com/primetechblog',
                  svg: (
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      viewBox='0 0 24 24'
          ...
          <div className='grid grid-cols-2 gap-8 sm:grid-cols-3 lg:col-span-3 lg:grid-cols-3'>
            <nav className='space-y-4'>
              ...
              <ul className='space-y-2'>
                {[
                  ...
                  <li key={topic}>
                    <Link
                      href={`/topics/${topic.toLowerCase().replace(/\s+/g, '-').replace('&', 'and')}`}
                      className='text-muted-foreground transition-colors hover:text-primary'
                    >
                      {topic}
                    </Link>
            ...
            <nav className='space-y-4'>
              ...
              <ul className='space-y-2'>
                {['About', 'Blog', 'Newsletter', 'Careers', 'Contact'].map(
                  (item) => (
                    <li key={item}>
                      <Link
        ...
        <div className='mt-12 lg:mt-16'>
          ...
          <p className='mb-4 text-center text-muted-foreground'>
            Join our newsletter for the latest tech articles and exclusive
            content.
          </p>
